...
- `routes(id, name, start_x, start_z, lap_length, span_x, span_z, kind,
  kind_user, outline)` — fingerprint: start within 120 m + length within 5 % + bounding-box
